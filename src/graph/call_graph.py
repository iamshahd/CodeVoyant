...
class CallGraphExtractor:
    ...
    def get_statistics(self) -> Dict:
        ...
        """
        functions = [
            n for n, d in self.graph.nodes(data=True) if d.get("type") == "function"
        ]
        methods = [
            n for n, d in self.graph.nodes(data=True) if d.get("type") == "method"
        ]
        ...
        return {
            ...
            "methods": len(methods),
            "avg_calls_per_function": self.graph.number_of_edges()
    ...
    def visit_Call(self, node):
        ...
        if self.current_function:
            ...
            if called_name:
                ...
                self.graph.add_edge(
                    self.current_function, called_name, call_type="direct"
                )
