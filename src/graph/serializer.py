...
class GraphSerializer:
    ...
    @staticmethod
    def to_json(
        graph: nx.DiGraph, output_path: str | Path, format_type: str = "node_link"
    ) -> None:
        """
    ...
    @staticmethod
    def to_graphml(graph: nx.DiGraph, output_path: str | Path) -> None:
        """
    ...
    @staticmethod
    def to_gexf(graph: nx.DiGraph, output_path: str | Path) -> None:
        """
    ...
    @staticmethod
    def to_pickle(graph: nx.DiGraph, output_path: str | Path) -> None:
        """
    ...
    @staticmethod
    def to_summary(graph: nx.DiGraph, output_path: str | Path) -> None:
        """
