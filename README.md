...
For data, you may download our already preprocessed data from [google drive](https://drive.google.com/file/d/12gqk6P4MjqZ0aYGVGZ1_zJw-RGJDD9RK/view?usp=sharing) which includes graphs for [rich](https://github.com/willmcgugan/rich), [httpx](https://github.com/encode/httpx), and [django](https://github.com/django/django) repositories. These repositories were chosen for their purely Python codebases and popularity. You may also analyze any repoository and generate graphs:
```bash
